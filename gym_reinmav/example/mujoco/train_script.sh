...
# then
    ...
    python ./train_hovering.py --save_path=$MODEL_SAVE_PATH --num_timesteps=$N_TIMESTEPS --num_env=$N_ENV --play=False --env=MujocoQuadQuat-v0 --logdir=$LOG_PATH --reward_scale=1.0 --nsteps=$N_STEP --nminibatches=$N_MINIBATCHES --noptepochs=$N_OPTEPOCHS
# fi
